...
public class DataView: JSBridgedType {
    ...
    public convenience init(buffer: ArrayBuffer) {
        ...
        self.init(objectRef: DataView.classRef.new(buffer.jsValue()))
    }
    
    public convenience init(buffer: ArrayBuffer, byteOffset: UInt32) {
        
        self.init(objectRef: DataView.classRef.new(buffer.jsValue(), byteOffset.jsValue()))
    }
    
    public convenience init(buffer: ArrayBuffer, byteOffset: UInt32, byteLength: UInt32) {
        
        self.init(objectRef: DataView.classRef.new(buffer.jsValue(), byteOffset.jsValue(), byteLength.jsValue()))
    }
